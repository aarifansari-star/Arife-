...
import { ArrowLeft, Gem, Bot, Play } from 'lucide-react';
      ...
      <div className="bg-slate-800/60 border border-cyan-500/30 rounded-3xl p-8 text-center mb-8 shadow-xl w-full">
        ...
        <div className="flex items-center justify-center gap-8 mb-8">
          <div className="flex flex-col items-center gap-1">
             ...
             <div className="w-14 h-14 rounded-full bg-red-500/20 border-[3px] border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.3)] mb-1" />
          ...
          <div className="flex flex-col items-center gap-1">
             ...
             <div className="w-14 h-14 rounded-full bg-yellow-500/20 border-[3px] border-yellow-500 shadow-[0_0_15px_rgba(234,179,8,0.3)] mb-1" />
