...
content = content.replace(
  ...
  '<img src="/loudomax-icon.png" alt="" onError={(e) => { e.currentTarget.style.display = \'none\' }} className="w-24 h-24 sm:w-[120px] sm:h-[120px] object-contain drop-shadow-2xl mb-6" />'
);
